...
### What is the structure of your dataset?
  ...
  There are 4898 observations of 13 
  variables. The variable 'quality' is based on the median rating by 3 wind experts. 
  ...
  i.e. 11 possible levels, where 6 levels are present in dataset i.e . 3-8.
...
### What other features in the dataset do you think will help support your \
  ...
  As stated above, only physicochemical data is available - Color, flavor, aroma 
  of wine can signficantly affect the perception of quality. 
  Therefore, having those features in this dataset would have helped performing 
  better analysis.
...
I'm also going to peak at the corolations between density and residual sugar and
...
Hmm, perhaps not worth investigating this.
...
```{r echo=FALSE, Plot_One}
  ...
  grid.arrange(p1, p2, ncol= 2, top=textGrob("Distribution of Wines",gp=gpar(fontsize=20,font=2)))
